...
private : string _Username;
	...
	static string _ConvertUserToLine(clsUser User)
	{
		return User.FirstName + "#||#" + User.LastName + "#||#" + User.Email + "#||#" + User.Phone + "#||#"
			+ User.Username() + "#||#" + User.Password + "#||#" + to_string(User.Permissions);
	}
...
public:
	...
	enum enPermissions {
		enClientList = 1, enAddNewClient = 2, enDeleteClient = 4, enUpdateClient = 8, enFindClient = 16, enTransactions = 32, enManageUser = 64
	};
