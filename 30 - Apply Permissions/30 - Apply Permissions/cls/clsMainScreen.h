...
{	
	...
	static void _ShowDeleteClientScreen()
	{
		...
		clsDeleteClientsScreen::DeleteClient();
	}
	...
	static void _ShowFindClientScreen()
	{
		...
		clsFindClients::FindClientsScreen();
	}
	...
	static void _PerformMainMenuOption(enMainMenueOption Option)
	{
		system("cls");
...
public:
	static void showMainMenue()
	{
		...
		while (_BackToMain)
		{
			...
			_PerformMainMenuOption(enMainMenueOption(clsInputValidation::ReadShortNumber(msg, 1, 8)));
		}	
	}
};
